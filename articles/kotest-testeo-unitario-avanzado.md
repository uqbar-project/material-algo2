...
![Kotest - nombre de variable no representativa](../images/kotest-variable-no-representativa.png)
...
![mas expresividad en los tests](../images/kotest-testeo-expresivo.png)
